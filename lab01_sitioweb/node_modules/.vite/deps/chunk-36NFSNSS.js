  ...
  mount(el) {
    ...
    const dispose2 = render(() => {
      ...
      if (__privateGet(this, _Component)) {
        ...
        Devtools = lazy(() => import("./FloatingTanStackRouterDevtools-B7vy70jP-YULPXZTD.js"));
  ...
  mount(el) {
    ...
    const dispose2 = render(() => {
      ...
      if (__privateGet(this, _Component2)) {
        ...
        BaseTanStackRouterDevtoolsPanel = lazy(() => import("./BaseTanStackRouterDevtoolsPanel-Bmws3ikM-HGGXM43R.js").then((n) => n.c));
...
//# sourceMappingURL=chunk-36NFSNSS.js.map
