import {
  useStore
} from "./chunk-LNWI2DTD.js";
import {
  batch,
  createStore
} from "./chunk-CLINMWPI.js";
import {
  require_jsx_runtime
} from "./chunk-A6UHPNFR.js";
import {
  require_react
} from "./chunk-3SIINOU2.js";
import {
  __privateAdd,
  __privateGet,
  __privateSet,
...
var EventClient = class {
  ...
  on(eventSuffix, cb, options) {
    const withEventTarget = (options == null ? void 0 : options.withEventTarget) ?? false;
    ...
    return () => {
      var _a;
      if (withEventTarget) {
        (_a = __privateGet(this, _internalEventTarget)) == null ? void 0 : _a.removeEventListener(eventName, handler);
      }
...
var FormApi = class {
  ...
  constructor(opts) {
    ...
    this.validateField = (field, cause) => {
      ...
      if (!fieldInstance) {
        ...
        if (hasErrored && !this.options.asyncAlways) {
          return ((_b = this.getFieldMeta(field)) == null ? void 0 : _b.errors) ?? [];
        }
        return this.validateAsync(cause).then(() => {
          var _a3;
          return ((_a3 = this.getFieldMeta(field)) == null ? void 0 : _a3.errors) ?? [];
        });
      }
    ...
    this.setFieldValue = (field, updater, opts2) => {
      ...
      const dontRunListeners = (opts2 == null ? void 0 : opts2.dontRunListeners) ?? false;
      const dontValidate = (opts2 == null ? void 0 : opts2.dontValidate) ?? false;
      batch(() => {
        if (!dontUpdateMeta) {
          this.setFieldMeta(field, (prev) => ({
            ...prev,
      ...
      if (!dontRunListeners) {
        (_a2 = this.getFieldInfo(field).instance) == null ? void 0 : _a2.triggerOnChangeListener();
      }
      if (!dontValidate) {
    ...
    this.insertFieldValue = async (field, index, value, options) => {
      ...
      const dontValidate = (options == null ? void 0 : options.dontValidate) ?? false;
      if (!dontValidate) {
    ...
    this._formId = (opts == null ? void 0 : opts.formId) ?? uuid();
    this._devtoolsSubmissionOverride = false;
    ...
    if (opts == null ? void 0 : opts.transform) {
      ...
      for (const errKey of Object.keys(baseStoreVal.errorMap)) {
        ...
        for (const fieldName of Object.keys(errKeyMap.fields)) {
          ...
          baseStoreVal.fieldMetaBase[fieldName] = {
            ...
            ...existingFieldMeta ?? {},
            errorSourceMap: {
              ...(existingFieldMeta == null ? void 0 : existingFieldMeta["errorSourceMap"]) ?? {},
              onChange: "form"
            },
            errorMap: {
              ...(existingFieldMeta == null ? void 0 : existingFieldMeta["errorMap"]) ?? {},
              [errKey]: fieldErr
            }
          };
        }
...
// node_modules/@tanstack/form-core/dist/esm/FieldGroupApi.js
...
// node_modules/@tanstack/form-core/dist/esm/transform.js
...
// node_modules/@tanstack/react-form/dist/esm/createFormHook.js
...
function useField(opts) {
  const [prevOptions, setPrevOptions] = (0, import_react2.useState)(() => ({
    form: opts.form,
    name: opts.name
  }));
  const [fieldApi, setFieldApi] = (0, import_react2.useState)(() => {
    return new FieldApi({
      ...opts
    });
  });
  ...
  const extendedFieldApi = (0, import_react2.useMemo)(() => {
...
// node_modules/@tanstack/react-form/dist/esm/useFormId.js
var React = __toESM(require_react(), 1);

// node_modules/@tanstack/react-form/dist/esm/useUUID.js
var import_react3 = __toESM(require_react(), 1);
function useUUID() {
  return (0, import_react3.useState)(() => uuid())[0];
}
...
function LocalSubscribe({
  ...
  return (0, import_jsx_runtime2.jsx)(import_jsx_runtime2.Fragment, { children: functionalUpdate(children, data) });
}
function useForm(opts) {
  const fallbackFormId = useFormId();
  const [prevFormId, setPrevFormId] = (0, import_react4.useState)(opts == null ? void 0 : opts.formId);
  const [formApi, setFormApi] = (0, import_react4.useState)(() => {
    return new FormApi({ ...opts, formId: (opts == null ? void 0 : opts.formId) ?? fallbackFormId });
  });
  if (prevFormId !== (opts == null ? void 0 : opts.formId)) {
    const formId = (opts == null ? void 0 : opts.formId) ?? fallbackFormId;
    setFormApi(new FormApi({ ...opts, formId }));
    setPrevFormId(formId);
  }
  const extendedFormApi = (0, import_react4.useMemo)(() => {
    const extendedApi = {
      ...formApi,
      handleSubmit: (...props) => {
    ...
    extendedApi.Field = function APIField(props) {
      return (0, import_jsx_runtime2.jsx)(Field, { ...props, form: formApi });
    };
  ...
  const hasRan = (0, import_react4.useRef)(false);
  useIsomorphicLayoutEffect(() => {
    if (!hasRan.current) return;
    if (!(opts == null ? void 0 : opts.transform)) return;
    mergeAndUpdate(formApi, opts.transform);
  }, [formApi, opts == null ? void 0 : opts.transform]);
  useIsomorphicLayoutEffect(() => {
    hasRan.current = true;
  });
...
// node_modules/@tanstack/react-form/dist/esm/useFieldGroup.js
...
function LocalSubscribe2({
  ...
  return (0, import_jsx_runtime3.jsx)(import_jsx_runtime3.Fragment, { children: functionalUpdate(children, data) });
}
function useFieldGroup(opts) {
  const [formLensApi] = (0, import_react5.useState)(() => {
    ...
    extendedApi.AppForm = function AppForm(appFormProps) {
      return (0, import_jsx_runtime3.jsx)(form.AppForm, { ...appFormProps });
    };
    extendedApi.AppField = function AppField(props) {
      return (0, import_jsx_runtime3.jsx)(form.AppField, { ...formLensApi.getFormFieldOptions(props) });
    };
    extendedApi.Field = function Field2(props) {
      return (0, import_jsx_runtime3.jsx)(form.Field, { ...formLensApi.getFormFieldOptions(props) });
    };
    extendedApi.Subscribe = function Subscribe(props) {
...
// node_modules/@tanstack/react-form/dist/esm/createFormHook.js
var fieldContext = (0, import_react6.createContext)(null);
...
function createFormHookContexts() {
  function useFieldContext() {
    const field = (0, import_react6.useContext)(fieldContext);
    if (!field) {
      throw new Error(
...
function createFormHook({
  ...
  function useAppForm(props) {
    ...
    const AppForm = (0, import_react6.useMemo)(() => {
      return ({ children }) => {
        return (0, import_jsx_runtime4.jsx)(formContext2.Provider, { value: form, children });
      };
    }, [form]);
    const AppField = (0, import_react6.useMemo)(() => {
      const AppField2 = ({ children, ...props2 }) => {
        return (0, import_jsx_runtime4.jsx)(form.Field, { ...props2, children: (field) => (
          // eslint-disable-next-line @eslint-react/no-context-provider
          (0, import_jsx_runtime4.jsx)(fieldContext2.Provider, { value: field, children: children(Object.assign(field, fieldComponents)) })
        ) });
      };
      return AppField2;
    }, [form]);
    const extendedForm = (0, import_react6.useMemo)(() => {
  ...
  function withFieldGroup({
    ...
    return function Render(innerProps) {
      const fieldGroupProps = (0, import_react6.useMemo)(() => {
        return {
