...
function useLinkProps(options, forwardedRef) {
  ...
  const currentLocationState = useRouterState({
    select: (s) => {
      ...
      return {
        search: leaf == null ? void 0 : leaf.search,
        hash: s.location.hash,
        path: leaf == null ? void 0 : leaf.pathname
        // path + params
      };
    },
...
function Script({
  ...
  if ((attrs == null ? void 0 : attrs.src) && typeof children === "string" && children.trim().length) {
    console.warn(
...
//# sourceMappingURL=chunk-6QK3422B.js.map
