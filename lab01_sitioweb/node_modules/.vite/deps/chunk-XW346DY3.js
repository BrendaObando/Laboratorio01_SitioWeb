...
var handleSerialError = (inner, index, err, routerCode) => {
  ...
  if (!inner.preload && !isRedirect(err) && !isNotFound(err)) {
    inner.serialError ?? (inner.serialError = err);
  }
};
...
var runLoader = async (inner, matchPromises, matchId, index, route) => {
  ...
  try {
    ...
    try {
      ...
      if (pendingPromise) await pendingPromise;
      if (isNotFound(e)) {
        await ((_e = (_d = route.options.notFoundComponent) == null ? void 0 : _d.preload) == null ? void 0 : _e.call(_d));
      }
      handleRedirectAndNotFound(inner, inner.router.getMatch(matchId), e);
      try {
        (_g = (_f = route.options).onError) == null ? void 0 : _g.call(_f, e);
      } catch (onErrorError) {
        error = onErrorError;
        handleRedirectAndNotFound(
          inner,
...
async function loadMatches(arg) {
  ...
  try {
    ...
    for (const result of settled) {
      ...
      if (isNotFound(reason)) {
        firstNotFound ?? (firstNotFound = reason);
      } else {
        firstUnhandledRejection ?? (firstUnhandledRejection = reason);
      }
    }
  ...
  if (notFoundToThrow) {
    ...
    if (!rootMatch.globalNotFound) {
      ...
      if (currentRootMatch == null ? void 0 : currentRootMatch.globalNotFound) {
...
//# sourceMappingURL=chunk-XW346DY3.js.map
